...
class IzincutiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $qcuti->select('presensi_izincuti.*', 'karyawan.nama_karyawan', 'karyawan.nik_show', 'jabatan.nama_jabatan', 'departemen.nama_dept', 'cabang.nama_cabang', 'cuti.jenis_cuti as nama_cuti');
