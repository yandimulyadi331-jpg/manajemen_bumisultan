...
class JamaahMasar extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'jamaah_masar';
     ...
     * Format: JM{URUT}{NIK2DIGIT}{TAHUN2DIGIT}
     * Contoh: JM00133625 (Urut: 0013, NIK 2 digit: 36, Tahun: 25)
     */
    public static function generateNomorJamaah($nik, $tahun_masuk, $id)
    {
        ...
        // Format: JM00133625
        return "JM{$urut}{$nik2digit}{$tahun2digit}";
    }
    ...
    /**
     * Relationship dengan kehadiran harian
     */
    public function kehadiran()
    {
        return $this->hasMany(KehadiranJamaahMasar::class, 'jamaah_id');
    }

    /**
     * Relationship dengan kehadiran mingguan
     */
    public function kehadiranMingguan()
    {
        return $this->hasMany(JumlahKehadiranMingguan::class, 'jamaah_id');
    }

    /**
     * Relationship dengan distribusi hadiah (legacy)
     */
    public function distribusiHadiah()
    {
        return $this->hasMany(DistribusiHadiahMasar::class, 'jamaah_id');
    }
    ...
    {
        return $this->hasMany(DistribusiHadiahYayasanMasar::class, 'jamaah_id');
    }
    ...
    {
        return $this->hasMany(PemenangUndianUmrohMasar::class, 'jamaah_id');
    }
