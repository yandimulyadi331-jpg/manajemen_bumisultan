@extends('layouts.app')
@section('titlepage', 'Edit Administrasi')

@section('content')
@section('navigasi')
    <span>Fasilitas & Asset / Manajemen Administrasi / Edit Data</span>
@endsection

<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('administrasi.update', $administrasi->id) }}" method="POST" enctype="multipart/form-data" id="formAdministrasi">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-header bg-warning text-white">
                    <h5 class="mb-0"><i class="ti ti-edit me-2"></i>Form Edit Administrasi - {{ $administrasi->kode_administrasi }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Jenis Administrasi -->
