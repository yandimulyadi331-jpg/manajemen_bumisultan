@extends('layouts.app')
@section('titlepage', 'Data Jamaah Majlis Ta\'lim Al-Ikhlas')

@section('content')
@section('navigasi')
    <span class="text-muted fw-light">Manajemen Yayasan /</span> Data Jamaah Majlis Ta'lim
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="ti ti-users me-2"></i>Data Jamaah Majlis Ta'lim Al-Ikhlas</h5>
