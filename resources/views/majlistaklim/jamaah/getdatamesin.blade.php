    ...
    <div class="col-12">
                        ...
                        <td>
                            <div class="d-flex gap-1 justify-content-center">
                                ...
                                <form method="POST" class="updatemasuk"
                                      action="{{ route('majlistaklim.jamaah.updatefrommachine', [Crypt::encrypt($d->pin), 0]) }}">
                                    @csrf
                                ...
                                <form method="POST" class="updatepulang"
                                      action="{{ route('majlistaklim.jamaah.updatefrommachine', [Crypt::encrypt($d->pin), 1]) }}">
                                    @csrf
                                    <input type="hidden" name="scan_date" 
                                           value="{{ date('Y-m-d H:i:s', strtotime($d->scan_date)) }}">
        ...
        @if(count($filtered_array) > 0)
            <div class="alert alert-warning mt-3">
                ...
                <ul class="mb-0 mt-2">
                    <li>Data akan disimpan ke tabel <code>kehadiran_jamaah</code></li>
