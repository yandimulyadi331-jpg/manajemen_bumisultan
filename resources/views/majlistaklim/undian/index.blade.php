    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('majlistaklim.undian.create') }}" class="btn btn-primary btn-sm">
...
<script>
    $(document).ready(function() {
        ...
        let table = $('#tableUndian').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('majlistaklim.undian.index') }}",
                data: function(d) {
        ...
        $(document).on('click', '.undi-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ url('majlistaklim/undian') }}/" + id + "/undi";
                }
            });
        });
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('majlistaklim/undian') }}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
