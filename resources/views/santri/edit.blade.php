@extends('layouts.app')
@section('titlepage', 'Edit Santri - Manajemen Saung Santri')

@section('content')
@section('navigasi')
    <span><a href="{{ route('santri.index') }}">Manajemen Saung Santri</a> / Edit Santri</span>
@endsection
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('santri.update', $santri->id) }}" method="POST" enctype="multipart/form-data" id="formSantri">
            @csrf
            @method('PUT')
            
            <div class="card">
                <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                    <h4 class="mb-0"><i class="ti ti-edit me-2"></i> Edit Data Santri</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="dataPribadi">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">NIS (Tidak bisa diubah)</label>
                                        <input type="text" class="form-control bg-light" 
                                            value="{{ $santri->nis }}" readonly disabled>
                                        <small class="text-muted">NIS dibuat otomatis oleh sistem dan tidak dapat diubah</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" 
                                            value="{{ old('nik', $santri->nik) }}" maxlength="16">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat_lengkap" class="form-control @error('alamat_lengkap') is-invalid @enderror" 
                                    rows="3" required>{{ old('alamat_lengkap', $santri->alamat_lengkap) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="provinsi" class="form-control" value="{{ old('provinsi', $santri->provinsi) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Kabupaten/Kota</label>
                                        <input type="text" name="kabupaten_kota" class="form-control" value="{{ old('kabupaten_kota', $santri->kabupaten_kota) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Kecamatan</label>
                                        <input type="text" name="kecamatan" class="form-control" value="{{ old('kecamatan', $santri->kecamatan) }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Kelurahan</label>
                                        <input type="text" name="kelurahan" class="form-control" value="{{ old('kelurahan', $santri->kelurahan) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_pos" class="form-control" value="{{ old('kode_pos', $santri->kode_pos) }}" maxlength="5">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_ayah" class="form-control @error('nama_ayah') is-invalid @enderror" 
                                            value="{{ old('nama_ayah', $santri->nama_ayah) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror" 
                                            value="{{ old('nama_ibu', $santri->nama_ibu) }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="pekerjaan_ayah" class="form-control" value="{{ old('pekerjaan_ayah', $santri->pekerjaan_ayah) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Pekerjaan Ibu</label>
                                        <input type="text" name="pekerjaan_ibu" class="form-control" value="{{ old('pekerjaan_ibu', $santri->pekerjaan_ibu) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="no_hp_ayah" class="form-control" value="{{ old('no_hp_ayah', $santri->no_hp_ayah) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">No. HP Ibu</label>
                                        <input type="text" name="no_hp_ibu" class="form-control" value="{{ old('no_hp_ibu', $santri->no_hp_ibu) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_wali" class="form-control" value="{{ old('nama_wali', $santri->nama_wali) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="hubungan_wali" class="form-control" 
                                            value="{{ old('hubungan_wali', $santri->hubungan_wali) }}" placeholder="Contoh: Paman, Kakak, dll">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">No. HP Wali</label>
                                        <input type="text" name="no_hp_wali" class="form-control" value="{{ old('no_hp_wali', $santri->no_hp_wali) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="dataPendidikan">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="asal_sekolah" class="form-control" value="{{ old('asal_sekolah', $santri->asal_sekolah) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="tingkat_pendidikan" class="form-select">
                                            <option value="">Pilih</option>
                                            <option value="SD" {{ old('tingkat_pendidikan', $santri->tingkat_pendidikan) == 'SD' ? 'selected' : '' }}>SD</option>
                                            <option value="SMP" {{ old('tingkat_pendidikan', $santri->tingkat_pendidikan) == 'SMP' ? 'selected' : '' }}>SMP</option>
                                            <option value="SMA" {{ old('tingkat_pendidikan', $santri->tingkat_pendidikan) == 'SMA' ? 'selected' : '' }}>SMA</option>
                                            <option value="Lainnya" {{ old('tingkat_pendidikan', $santri->tingkat_pendidikan) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="status_santri" class="form-select @error('status_santri') is-invalid @enderror" required>
                                            ...
                                            <option value="cuti" {{ old('status_santri', $santri->status_santri) == 'cuti' ? 'selected' : '' }}>Cuti</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status_aktif" class="form-select" required>
                                    ...
                                    <option value="nonaktif" {{ old('status_aktif', $santri->status_aktif) == 'nonaktif' ? 'selected' : '' }}>Non-Aktif</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="dataHafalan">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="target_hafalan" class="form-control" 
                                            value="{{ old('target_hafalan', $santri->target_hafalan) }}" placeholder="Contoh: 30 Juz">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal_mulai_tahfidz" class="form-control" 
                                            value="{{ old('tanggal_mulai_tahfidz', $santri->tanggal_mulai_tahfidz) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal_khatam_terakhir" class="form-control" 
                                            value="{{ old('tanggal_khatam_terakhir', $santri->tanggal_khatam_terakhir) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="catatan_hafalan" class="form-control" rows="4" 
                                    placeholder="Catatan progress hafalan, prestasi, atau informasi lainnya">{{ old('catatan_hafalan', $santri->catatan_hafalan) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="dataAsrama">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_asrama" class="form-control" value="{{ old('nama_asrama', $santri->nama_asrama) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Nomor Kamar</label>
                                        <input type="text" name="nomor_kamar" class="form-control" value="{{ old('nomor_kamar', $santri->nomor_kamar) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Pembina</label>
                                        <input type="text" name="nama_pembina" class="form-control" value="{{ old('nama_pembina', $santri->nama_pembina) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="keterangan" class="form-control" rows="4" 
                                    placeholder="Keterangan atau informasi tambahan lainnya">{{ old('keterangan', $santri->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-device-floppy me-1"></i> Update Data Santri
                        </button>
                    </div>
                </div>
            </div>
