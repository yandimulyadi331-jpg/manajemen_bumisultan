...
@section('title', 'Tambah Aktivitas Karyawan')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            <i class="ti ti-plus me-2"></i>Tambah Aktivitas Karyawan
                        </h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('aktivitaskaryawan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="lokasi" id="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                                            value="{{ old('lokasi') }}" placeholder="Masukkan lokasi aktivitas">
                                        @error('lokasi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="aktivitas" id="aktivitas" rows="5" class="form-control @error('aktivitas') is-invalid @enderror"
                                    placeholder="Deskripsikan aktivitas yang dilakukan..." required>{{ old('aktivitas') }}</textarea>
                                @error('aktivitas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
