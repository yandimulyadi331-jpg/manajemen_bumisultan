...
@section('content')
    ...
    <div id="content-section">
        <div class="idcard-wrapper">
            ...
            @if (!empty($yayasan_masar->foto))
                @if (Storage::disk('public')->exists('/yayasan-masar/' . $yayasan_masar->foto))
                    <img src="{{ getfotoYayasanMasar($yayasan_masar->foto) }}" class="profile-pic-modern" alt="Profile Picture">
                @else
            ...
            <div class="idcard-body-modern">
                <div class="idcard-name-modern">{{ textUpperCase($yayasan_masar->nama) }}</div>
                <div class="idcard-position-modern">{{ $yayasan_masar->nama_dept }}</div>

                <div class="idcard-info-modern"><i class="fa-solid fa-id-badge"></i> ID: {{ $yayasan_masar->nik }}</div>
                <div class="idcard-info-modern"><i class="fa-solid fa-calendar-plus"></i> Join Date:
                    {{ date('d-m-Y', strtotime($yayasan_masar->tanggal_masuk)) }}</div>
                <div class="idcard-info-modern"><i class="fa-solid fa-phone"></i> {{ $yayasan_masar->no_hp }}</div>
                <div class="idcard-info-modern"><i class="fa-solid fa-user"></i> {{ $yayasan_masar->nama_jabatan }}</div>
                <div class="barcode-modern">
                    {!! DNS1D::getBarcodeHTML($yayasan_masar->nik, 'C128', 2, 54) !!}
                </div>
            </div>
            ...
            if (btn) {
                btn.addEventListener('click', function() {
                    ...
                    html2canvas(area, {
                        ...
                        link.download = 'idcard-{{ $yayasan_masar->nik }}.jpg';
