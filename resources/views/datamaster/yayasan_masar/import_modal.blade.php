<div class="row">
    <div class="col-12">
        <form action="{{ route('yayasan_masar.import_proses') }}" method="POST" enctype="multipart/form-data" id="frmImport">
            @csrf
            <div class="row">
                <div class="col-12">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="form-group">
                        <a href="{{ route('yayasan_masar.download_template') }}" class="btn btn-success">
