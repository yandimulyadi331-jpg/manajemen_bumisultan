...
<div id="content-section">
    <div class="form-card">
        ...
        <form action="{{ route('izinsakit.store') }}" method="POST" id="formIzin" autocomplete="off" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group-modern">
                ...
                <textarea placeholder="Alasan mengajukan izin sakit..." class="feedback-input keterangan" name="keterangan" style="height: 100px"></textarea>
            </div>

            <div class="form-group-modern">
                <label class="form-label-modern">
                    Surat Izin Dokter (SID)
                </label>
                <input type="file" class="feedback-input sid" name="sid" />
            </div>

            <button class="btn-submit" id="btnSimpan" type="submit">
                <ion-icon name="checkmark-circle-outline"></ion-icon>
                <span>Buat Izin Sakit</span>
            </button>
        </form>
    </div>
</div>
