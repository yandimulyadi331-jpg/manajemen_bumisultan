        ...
        <table class="datatable3">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="background:red; color:white">Pot. Pinjaman</th>
                ...
                @foreach ($laporan_presensi as $d)
                    ...
                    <tr>
                        ...
                        @php
                            ...
                            $potongan_pinjaman = $d['total_potongan_pinjaman'] ?? 0;
                            $total_potongan = ROUND($jumlah_potongan_jam) + $total_denda + $d['bpjs_kesehatan'] + $d['bpjs_tenagakerja'] + $potongan_pinjaman;
                            ...
                            $total_potongan_pinjaman += $potongan_pinjaman;
                        ...
                        <td style="text-align: right">{{ formatAngka($potongan_pinjaman) }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align: right">{{ formatAngka($total_potongan_pinjaman) }}</th>
