    ...
    <div class="container">
        @foreach ($laporan_presensi as $d)
            ...
            @php
                // Final calculations
                $jumlah_potongan_jam = ROUND($upah_perjam) * $total_potongan_jam;
                $total_potongan = ROUND($jumlah_potongan_jam) + $total_denda + $d['bpjs_kesehatan'] + $d['bpjs_tenagakerja'] + $d['total_potongan_pinjaman'];
            ...
            <div class="slip-struk">
                ...
                <div class="employee-section">
                    <div class="row">
                        ...
                        <span class="value">{{ $d['nik_show'] ?? $d['nik'] }}</span>
                    </div>
                    <div class="row">
                ...
                <div class="total-section">
                    <div class="net-salary">
                        ...
                        <span class="currency">
                            @php
                                $gaji_bersih =
                                    $d['gaji_pokok'] + $total_tunjangan + ROUND($upah_lembur) - $total_potongan + $d['penambah'] - $d['pengurang'];
                            @endphp
