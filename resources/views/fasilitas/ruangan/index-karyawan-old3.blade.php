...
@section('content')
    <style>
        ...
        #gedung-info {
            ...
            border: 2px solid rgba(50, 116, 94, 0.15);
        }
        ...
        .info-gedung-row {
            ...
            padding: 12px 0;
            border-bottom: 1.5px solid rgba(50, 116, 94, 0.1);
        }

        .info-gedung-row:last-child {
            border-bottom: none;
        }
            ...
            <div class="ruangan-scroll-container">
                @foreach ($ruangan as $index => $d)
                    @php
                        ...
                        $badges = ['STANDARD', 'PREMIUM', 'BASIC'];
                        $badgeText = $badges[$index % 3];
                    @endphp
                    
                    <div style="width: 100%;">
                        <div class="pricing-card {{ $variantClass }}" data-ruangan-id="{{ $d->id }}" data-variant="{{ $variantClass }}">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-stats">
                                    ...
                                    @if($d->luas)
                                        <div class="stat-item">
                                            <div class="stat-label">
                                                <ion-icon name="resize-outline"></ion-icon> Luas
                                            </div>
                                            <div class="stat-value">
                                                {{ $d->luas }} m²
                                            </div>
                                    ...
                                    @if($d->kapasitas)
                                        <div class="stat-item">
                                            ...
                                            <div class="stat-value">
                                                <div class="stat-icon">{{ $d->kapasitas }}</div>
                                                Orang
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="card-footer">
                                    <button class="btn-card-action" onclick="toggleDetail('ruangan-{{ $d->id }}', event)">
                        ...
                        {{-- Detail Panel --}}
                        <div class="detail-panel {{ $variantClass }}" id="ruangan-{{ $d->id }}">
                            <div class="detail-content">
                                <div class="detail-header">
                                    ...
                                    <button class="detail-close" onclick="toggleDetail('ruangan-{{ $d->id }}', event)">
                                ...
                                <div class="detail-grid">
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value">{{ $d->nama_ruangan }}</div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value">{{ $d->kode_ruangan }}</div>
                                    </div>
