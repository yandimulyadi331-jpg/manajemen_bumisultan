                ...
                <form id="formEditRekapKehadiran" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <a href="{{ route('masar.kehadiran.index') }}" class="btn btn-link">Batal</a>
...
$(document).ready(function() {
    ...
    $('#formEditRekapKehadiran').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('masar.kehadiran.update', $rekap->id) }}",
            type: 'POST',
            data: formData,
            success: function(response) {
                Swal.fire({
                    ...
                    window.location.href = "{{ route('masar.kehadiran.index') }}";
                });
            },
            error: function(xhr) {
