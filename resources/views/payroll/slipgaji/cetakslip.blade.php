...
@foreach ($presensi as $d)
    ...
    @php
        ...
        // Ambil data potongan pinjaman dari tabel potongan_pinjaman_payroll
        $potongan_pinjaman = DB::table('potongan_pinjaman_payroll')
            ->join('pinjaman', 'potongan_pinjaman_payroll.pinjaman_id', '=', 'pinjaman.id')
            ->where('potongan_pinjaman_payroll.nik', $d['nik'])
            ->where('potongan_pinjaman_payroll.bulan', $bulan)
            ->where('potongan_pinjaman_payroll.tahun', $tahun)
        ...
        $total_potongan_pinjaman = $potongan_pinjaman->sum('jumlah_potongan');
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="salary-section">
                    ...
                    @if($potongan_pinjaman->count() > 0)
                        @foreach($potongan_pinjaman as $pot)
                            <div class="salary-component">
                                <div class="salary-label">Cicilan Pinjaman {{ $pot->jenis_pinjaman }}</div>
                                <div class="salary-value">{{ rupiah($pot->jumlah_potongan) }}</div>
                            </div>
                        @endforeach
                    @endif
                    <div class="salary-component">
