    ...
    <div class="col-lg-5 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                ...
                @endcan
                @can('slipgaji.index')
                    <a href="#" class="btn btn-success" id="btnKirimEmail"><i class="fa fa-envelope me-2"></i> Kirim Email Slip Gaji</a>
                @endcan
            </div>
            <div class="card-body">
                <div class="row">
...
<script>
    $(function() {
        ...
        $("#btnKirimEmail").click(function(e) {
            e.preventDefault();
            $("#modal").modal("show");
            $("#modal").find(".modal-title").text("Kirim Slip Gaji via Email");
            $("#loadmodal").load(`/slipgaji/select-karyawan`);
        });
    });
</script>
@endpush
