                                ...
                                <tbody>
                                    @forelse($kunjungan as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->foto)
                                                    <img src="{{ asset('storage/uploads/kunjungan/' . $item->foto) }}" alt="Foto Kunjungan"
                                                        ...
                                                        onclick="showImageModal('{{ asset('storage/uploads/kunjungan/' . $item->foto) }}', 'Foto Kunjungan - {{ $item->karyawan->nama_karyawan ?? $item->nik }}')">
                                                @else
                                            ...
                                            <td>
                                                <div>
                                                    <strong>{{ $item->tanggal_kunjungan->format('d/m/Y') }}</strong><br>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    @can('kunjungan.index')
                                                        <div>
                                                            <a href="{{ route('kunjungan.show', $item) }}" class="me-2">
                                                    ...
                                                    @can('kunjungan.edit')
                                                        <div>
                                                            <a href="{{ route('kunjungan.edit', $item) }}" class="me-2">
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <p class="mt-2">Tidak ada data kunjungan</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
