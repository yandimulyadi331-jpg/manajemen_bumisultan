    ...
    <div class="form-card">
        ...
        <form action="{{ route('izinabsen.store') }}" method="POST" id="formIzin" autocomplete="off">
            ...
            <div class="form-group-modern">
                ...
                <textarea placeholder="Alasan mengajukan izin absen..." class="feedback-input keterangan" name="keterangan" style="height: 100px"></textarea>
            </div>

            <button class="btn-submit" id="btnSimpan" type="submit">
                <ion-icon name="checkmark-circle-outline"></ion-icon>
                <span>Buat Izin Absen</span>
            </button>
        </form>
    </div>
</div>
