...
@section('content')
@section('navigasi')
   <span class="text-muted fw-light">Keuangan Tukang /</span> Pembayaran Cash Lembur
@endsection
         ...
         <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
               ...
               <div class="d-flex gap-2">
                  ...
                  <form action="{{ route('keuangan-tukang.lembur-cash') }}" method="GET" class="d-flex align-items-center">
...
function toggleCash(button) {
   ...
   $.ajax({
      url: '{{ route("keuangan-tukang.toggle-lembur-cash") }}',
      method: 'POST',
      data: {
         _token: '{{ csrf_token() }}',
