...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('hadiah_yayasan_masar')) {
            Schema::create('hadiah_yayasan_masar', function (Blueprint $table) {
                $table->id();
                ...
                $table->json('stok_ukuran')->nullable()->comment('Stok per ukuran dalam JSON format');
    ...
    {
        Schema::dropIfExists('hadiah_yayasan_masar');
    }
};
