...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('hadiah_masar')) {
            Schema::create('hadiah_masar', function (Blueprint $table) {
                $table->id();
                ...
                $table->json('stok_ukuran')->nullable()->comment('Stok per ukuran dalam format JSON');
    ...
    public function down(): void
    {
        ...
        // Schema::dropIfExists('hadiah_masar');
    }
};
