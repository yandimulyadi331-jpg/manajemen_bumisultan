...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('undian_umroh_masar')) {
            Schema::create('undian_umroh_masar', function (Blueprint $table) {
                $table->id();
                $table->string('nomor_undian', 50)->unique()->comment('Format: UUM-TAHUN-URUT');
    ...
    public function down(): void
    {
        ...
        // Schema::dropIfExists('undian_umroh_masar');
    }
};
