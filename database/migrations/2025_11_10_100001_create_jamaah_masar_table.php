...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('jamaah_masar')) {
            Schema::create('jamaah_masar', function (Blueprint $table) {
                $table->id();
                $table->string('nomor_jamaah', 50)->unique()->comment('Format: MA-URUT-NIK2DIGIT-ID-TAHUN2DIGIT');
    ...
    public function down(): void
    {
        ...
        // Schema::dropIfExists('jamaah_masar');
    }
};
