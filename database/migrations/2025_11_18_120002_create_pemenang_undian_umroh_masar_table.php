...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('pemenang_undian_umroh_masar')) {
            Schema::create('pemenang_undian_umroh_masar', function (Blueprint $table) {
                $table->id();
                $table->foreignId('undian_id')->constrained('undian_umroh_masar')->onDelete('cascade');
                ...
                $table->unique(['undian_id', 'jamaah_id'], 'unique_undian_jamaah_masar');
            });
        }
    }
    ...
    public function down(): void
    {
        ...
        // Schema::dropIfExists('pemenang_undian_umroh_masar');
    }
};
